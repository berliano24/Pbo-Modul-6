...
import tugas.helpers.Encryptor;

public class PasswordStores {
    public int id;
     ...
     * @param plainPass
     */
    public PasswordStores(String name, String username, String plainPass){
     ...
     * @param category
     */
    public PasswordStores(String name, String username, String plainPass, int category, Folder folder){
        try {
            this.hashkey = Encryptor.generateKey();
        } catch (NoSuchAlgorithmException ex) {
            Logger.getLogger(PasswordStores.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public PasswordStores(int id, String name, String username, String password, 
